...
<div class="options_group dhl-dimensions">
	<p class="form-field dimensions_field">
		...
		<span class="wrap">
			...
			<?php echo wp_kses_post( wc_help_tip( __( 'Custom DHL dimensions (optional). These will be used instead of the default product dimensions when calculating DHL shipping rates.', 'woocommerce-shipping-dhl' ) ) ); ?>
		</p>
</div> 
